  ...
  return (
    <div className='aboutMain h-full p-10 md:p-12'>
     ...
     <div className='flex flex-col lg:flex-row py-20'>
      <img className="p-10 flex-1 h-96 rounded-4xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300" src="gallery-img-5.jpeg" alt="product image" />
